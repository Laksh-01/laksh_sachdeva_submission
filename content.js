...
function createInputField(chatArea) {
    ...
    inputField.style.fontFamily = "'Roboto', sans-serif"; // Modern font
inputField.style.fontSize = "16px"; 
inputField.style.fontWeight = "500"; // Slightly bold for emphasis
...
function addChatMessage(sender, message, chatArea) {
    ...
    if (sender === "You") {
        ...
        senderLabelContainer.appendChild(profileImage);
    } else {
        senderLabelContainer.appendChild(profileImage);
        senderLabelContainer.appendChild(senderLabel);
    }
...
async function loadPreviousConversation(chatArea) {
    ...
    if(conversationHistory.length === 0){
        addChatMessage("System", "Got doubts? 🤔 Feel free to ask me! 💡 I'm here to help. 😊",  chatArea);
    }
}
